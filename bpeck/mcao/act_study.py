...
def print_calc_side(act_start, act_stop, act_step, sigfigs=3):
    ...
    sides, actuators = utils.calc_side(act_start, act_stop, act_step, sigfigs=sigfigs)
...
def print_mag_to_flux(act_start, act_stop, act_step, 
    ...
    lgs_siglev, lgs_bkgrnd, lgs_nearecon = utils.lgs_flux_params(act_start, act_stop, act_step, lgs_mag, tt_mag)
    tt_siglev, tt_bkgrnd, tt_nearecon = utils.tt_flux_params(act_start, act_stop, act_step, lgs_mag, tt_mag)
    truth_siglev, truth_bkgrnd, truth_nearecon = utils.truth_flux_params(act_start, act_stop, act_step, lgs_mag, tt_mag)
